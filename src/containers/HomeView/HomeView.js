...
export class HomeView extends Component {
    ...
    doctors = [
        {
            title: 'Dr. B. Samarasinghe',
            speciality: 'Consultant Surgeon',
            qualification: 'MBBS, MS'
        },
        {
            title: 'Dr. S. L. Kandegedara',
            speciality: 'Consultant Clinical Oncologists',
            qualification: 'MBBS, MS'
        },
        {
            title: 'Dr. H. B. Jayasinghe',
            speciality: 'Family Medicine',
            qualification: 'MBBS Cey, FCGP SL'
        },
        {
            title: 'Dr. S. Selvaratnam',
                ...
                <Col md="4" className="p-2">
                    <Card className="h-100" style={{ 'background': '#448AFF', 'color': '#FFF' }}>
                        <CardBody>
                            ...
                            <CardText><p className="font-weight-bold">+94812065030</p></CardText>
                        </CardBody>
                    </Card>
                </Col >
                <Col md="4" className="p-2">
                        ...
                        <div className="container">
                            <div className="row ">
                                ...
                                <div className="col-md-4 text-white my-4 text-center text-md-left ">
                                    ...
                                    <p className="text-white">Aromed Medical &amp; Channelled Consultation Center, Kiribathkumbura</p>
